		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pago de detracciones en SUNAT",
									"targetURL": "#pluspepagodetracsunat-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pluspepagodetracsunat-display": {
								"semanticObject": "pluspepagodetracsunat",
								"action": "display",
								"description": "Pago de detracciones en SUNAT",
								"title": "Pago de detracciones en SUNAT",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pluspe.pagodetracsunat",
									"url": sap.ui.require.toUrl("pluspe/pagodetracsunat")
								}
							}
						}
					}
